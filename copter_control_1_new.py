...
move_to(base_telemetry.x, base_telemetry.y, base_telemetry.z)
rospy.loginfo('step 2. hold aruco, done')
rospy.sleep(5.0)

# step 3. move to x + 2
telemetry = get_telemetry('aruco_map')
move_to(base_telemetry.x + 1.5, base_telemetry.y, base_telemetry.z, speed=0.1)
rospy.loginfo('step 3. move to x +2, done')
rospy.sleep(5.0)

# step 3. move to y + 2
telemetry = get_telemetry('aruco_map')
move_to(base_telemetry.x + 1.5, base_telemetry.y + 1.5, base_telemetry.z, speed=0.1)
rospy.loginfo('step 3. move to y + 2, done')
rospy.sleep(5.0)
...
# step 3, rotate 90
# rotate(math.radians(90), math.radians(90))
